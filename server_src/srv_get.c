...
/*   Updated: 2018/10/22 16:17:14 by bhamidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "server.h"

int		get_file_len(const int fd)
{
	struct stat		buf;
...
void	send_file(int sock, int fd, int nloop)
{
	char	buf[1024];
	int		r;
...
void	transfer_file(int sock, int fd, int file_len)
{
