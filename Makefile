...
#    Updated: 2018/10/24 13:28:37 by bhamidi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SERVER_OBJ		= server.o server_fork.o srv_ls.o srv_pwd.o environement.o srv_cd.o srv_get.o srv_put.o srv_mkdir.o array.o srv_rmdir.o
SERVER_OBJS		= $(addprefix $(SERVER_PATH), $(SERVER_OBJ))
SERVER_HEADER	= server.h

CLIENT			= client
CLIENT_PATH		= client_src/
CLIENT_OBJ		= client.o array.o cmd_pwd.o cmd_ls.o cmd_cd.o cmd_get.o cmd_put.o cmd_mkdir.o cmd_rmdir.o
